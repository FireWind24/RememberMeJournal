...
const SECTIONS: Section[] = [
  {
    ...
    items: [
      ...
      { tip: 'Formatting while writing', detail: 'You can format as you write: ** for bold, * for italic, __ to underline, > for quote and --- for divider. Renders beautifully when you read it back.' },
