...
const SECTIONS: Section[] = [
  {
    ...
    items: [
      ...
      { tip: 'Formatting while writing', detail: 'You can format as you write: double stars for bold, single stars for italic, double underscores to underline, > for quote and --- for divider. Renders beautifully when you read it back.' },
